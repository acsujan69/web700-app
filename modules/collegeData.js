...
var sequelize = new Sequelize('SenecaDB', 'SenecaDB_owner', '4TNUK3gbhkmf', {
    host: 'ep-flat-art-a5qrbwoe.us-east-2.aws.neon.tech', // Database host
...
// Function to retrieve students who are Teaching Assistants
module.exports.getStudentByTA = function () {
    return new Promise(function (resolve, reject) {
        Student.findAll({
            where: { TA: 't' } // Filter student by TA status
        })
            .then(data => resolve(data)) // Resolve with the array of results
            .catch(() => reject("no results returned")); // Reject if an error occurs
    });
};
